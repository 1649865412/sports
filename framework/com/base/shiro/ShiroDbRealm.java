...
public class ShiroDbRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) throws AuthenticationException {
		...
		if (user != null) {
			...
			shiroUser.setUser(reLoadUserSet(user));
	...
	/**
	 * 功能:修改登陆超时后，重新登陆成功，在过滤器中首次无法获取用户对应用户详情信息
	 * <p>作者 杨荣忠 2014-10-28 下午04:14:04
	 * @param user
	 * @return
	 */
	public User reLoadUserSet(User u){
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		...
		{
			User preUser = shiroUser.getUser();
			
			if(StringUtils.isNotEmpty( preUser.getSwitchBrandId()))
			{
				user.setSwitchBrandId(preUser.getSwitchBrandId());
				user.setUseBrandId(preUser.getSwitchBrandId());
			}
		}
