...
public class SqlDao {
	...
	//	
	//	@Resource(name = "reptileEntityManagerFactory")
	//	private EntityManagerFactory reptileEm;
	//	
	...
	//	public void setReptileEm() {
	//		em = reptileEm.createEntityManager();
	//	}
	public void setOcsEm() {
		if(null != ocsEm)
		{
			em = ocsEm.createEntityManager();
		}
		
	}

	public String queryString(String excuteSql){
		List listResult = em.createNativeQuery(excuteSql).getResultList();
	...
	public <T> T querySingleObj(String executeSql,
			Class<T> clazz) throws Exception {
	...
	public int updateBySql(String executeSql) throws Exception {
