...
<form method="post" action="${contextPath }/scheduler/job/update" class="required-validate pageForm" onsubmit="return validateCallback(this, dialogReloadNavTab);">
	...
	<div class="pageFormContent" layoutH="58" style="width:500;">
	<p>
		<label>Job 名称：</label>
	...
	<p><label> Cron表达式说明 ：</label>（必填，Cron表达式(如"0/10 * * ? * * *"，每10秒中执行调试一次)，对使用者要求比较，要会写Cron表达式）</p>
	<p>
		<label>描述：</label>
		<textarea rows="3" cols="20" name="descs" >
		 ${qrtzJob.remark} 
		</textarea> 
	</p>	 
	</div>
