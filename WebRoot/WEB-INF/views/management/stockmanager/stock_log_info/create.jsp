...
<form method="post" action="${contextPath }/management/stockLogInfo/create" class="required-validate pageForm" onsubmit="return validateCallback(this, dialogReloadNavTab);">
	<div class="pageFormContent" layoutH="58">
	<p>
		<label>stockId：</label>
		<input type="text" name="stockId" maxlength="10" class="input-medium required validate[required]"/>
	</p>	
	<p>
		<label>69码：</label>
