...
<form method="post" action="${contextPath }/management/emailManager/create" class="required-validate pageForm" onsubmit="return validateCallback(this, dialogReloadRel);">
