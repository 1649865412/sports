...
<input id="file_upload" type="file"
	uploaderOption="{
        ...
        'queueID':'fileQueue',
        'fileObjName':'files',
        'uploader':'${contextPath}/management/orderManager/upload;jsessionid=<%=session.getId()%>',
        ...
        onUploadSuccess : function(file, data, response) {
        	...
        	$.ajax({url:'${contextPath}/management/orderManager/parseData?orderType=${orderType}&fileName='+encodeURIComponent(encodeURIComponent(file.name)),
        		type: 'post',
        		dataType :'text',
        		success	: function(data, textStatus){
        				alertMsg.correct('导入成功！');
        				$('#refreshOrderManagerForm' , parent.document).submit(); 
        			},
