...
<form method="post" action="${contextPath }/management/tradEmailManager/update" class="required-validate pageForm" onsubmit="return validateCallback(this, dialogReloadRel);">
