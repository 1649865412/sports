...
<dwz:paginationForm action="${contextPath }/management/tradEmailManager/list" page="${page }">
...
<form method="post" action="${contextPath }/management/tradEmailManager/list" onsubmit="return navTabSearch(this)">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<shiro:hasPermission name="TradeManagement:view">
				<li><a iconClass="magnifier" target="dialog" mask="true" width="830" height="450" rel="SendEmailInfo_view" href="${contextPath }/management/tradEmailManager/view/{slt_uid}"><span>查看接收人信息</span></a></li>
			</shiro:hasPermission>		
			<shiro:hasPermission name="TradeManagement:view">
				<li><a class="add" target="dialog" mask="true" width="830" height="450" rel="SendEmailInfo_save" href="${contextPath }/management/tradEmailManager/create"><span>添加接收人信息</span></a></li>
			</shiro:hasPermission>
			<shiro:hasPermission name="TradeManagement:view">
				<li><a class="edit" target="dialog" mask="true" width="830" height="450" rel="SendEmailInfo_edit" href="${contextPath }/management/tradEmailManager/update/{slt_uid}"><span>编辑接收人信息</span></a></li>
			</shiro:hasPermission>
			<shiro:hasPermission name="TradeManagement:view">
				<li><a class="delete" target="selectedTodo" rel="ids" href="${contextPath }/management/tradEmailManager/delete" title="确认要删除选定接收人信息?"><span>删除接收人信息</span></a></li>
			</shiro:hasPermission>
		</ul>
	</div>
