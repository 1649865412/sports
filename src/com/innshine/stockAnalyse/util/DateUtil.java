...
public class DateUtil
{
	...
	// 同比n年的时间范围
	public static String comparYearTime(String nowTime, int year)
			throws ParseException
	{
		Calendar now = Calendar.getInstance();
			...
			throws ParseException
	{
		...
		{
			array = OtherTool.concat(array, Constant.Z_MONTH[i]);
		}
		return array;
	}
	...
	{
		// System.out.println(persentFormat(1.815));
		System.out.println(changeMoneyType(-19.3666));
		// System.out.println(getXcDay("2014-07-1", "2014-07-35"));
		// getXcDay(String strDateStart, String strDateEnd)

		// System.out.println(nextMonth("2014-02-3"));
	}
